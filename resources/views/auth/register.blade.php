    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-text-input data-cy="name" id="name" class="block mt-1 w-full text-gray-500" type="text" name="name" :value="old('name')" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-text-input data-cy="email" id="email" class="block mt-1 w-full text-gray-500" type="email" name="email" :value="old('email')" required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="password_confirmation" class="block mt-1 w-full text-gray-500"
                                type="password"
